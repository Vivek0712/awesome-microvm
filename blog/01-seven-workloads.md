...
[Part 3](https://builder.aws.com/content/3JJ7tASPSSUUTrcpWnWtxOuu8g3/a-kernel-for-every-customer-scaling-ai-agents-to-1000-tenants-on-aws-lambda-microvms-with-microvm-ctl) takes the pattern that ties all seven together, identity injected at launch through runHookPayload, and builds the one workload that stresses it hardest: one microVM per tenant, running a private AI agent for each customer.
