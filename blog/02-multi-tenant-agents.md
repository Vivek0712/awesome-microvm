---
title: "One AWS Lambda MicroVM per tenant: multi-tenant AI agents and what the series taught us"
description: "The finale: a private Bedrock-backed assistant per customer, each in its own Firecracker VM, identity injected at launch, conversation history in RAM, and near-zero idle cost. Plus the decision guide and lessons distilled from building eight workloads on Lambda MicroVMs."
