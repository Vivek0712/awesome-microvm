...
Series: [part 2, section 6 of Building on AWS Lambda MicroVMs](../../blog/01-seven-workloads.md). Full write-up: [Ephemeral CI runners on AWS Lambda MicroVMs: a fresh VM for every job](../../blog/deep-dives/06-ci-runner.md). Code: [github.com/Vivek0712/awesome-microvm/tree/main/examples/ci-runner](https://github.com/Vivek0712/awesome-microvm/tree/main/examples/ci-runner). Live transcript: [demo-ci-runner.png](../../blog/img/demo-ci-runner.png).
